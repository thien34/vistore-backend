        ...
        <>
            <div className='mb-5 bg-[#fff] rounded-lg shadow-md p-6 min-h-40'>
                <Collapse defaultActiveKey={['1']} className='mb-6'>
                    <Panel header={ProductAttributeMappingConfigs.resourceKey} key='1'>
                        <Tabs defaultActiveKey='1' type='card' size='middle'>
                            <Tabs.TabPane tab='Attributes' key='1'>
                                <ProductAttributeMapping />
                            </Tabs.TabPane>
                            <Tabs.TabPane tab='Attribute combinations' key='2'>
                                <ProductAtbCombinationsManage />
                            </Tabs.TabPane>
                        </Tabs>
                    </Panel>
                </Collapse>
                    ...
                    <Panel header='Product Specification Attributes' key='1'>
                        <Table
                            ...
                            pagination={{
                                ...
                                total: listResponse?.totalPages * (filter.pageSize ?? 6) || 0,

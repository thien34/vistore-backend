...
public class SpecificationAttributeServiceImpl implements SpecificationAttributeService {
    ...
    @Override
    @Transactional
    public SpecificationAttributeUpdateResponse editSpecificationAttribute(Long id, SpecificationAttributeUpdateRequest request) {
        ...
        // Handle SpecificationAttributeGroup if provided
        if (request.getSpecificationAttributeGroupId() != null && !request.getSpecificationAttributeGroupId().trim().isEmpty()) {
            SpecificationAttributeGroup specificationAttributeGroup = specificationAttributeGroupRepository.findById(Long.parseLong(request.getSpecificationAttributeGroupId()))
        ...
        Map<Long, SpecificationAttributeOption> existingOptionsMap = specificationAttributeOptionRepository.findBySpecificationAttributeId(id)
                .stream()
        ...
        // Set the updated options back to the SpecificationAttribute
        specificationAttribute.setSpecificationAttributeOptions(new ArrayList<>(updatedOptions));
        specificationAttribute = specificationAttributeRepository.save(specificationAttribute);

        // Return the updated SpecificationAttributeUpdateResponse
